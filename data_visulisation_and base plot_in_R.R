...
c = table(mtcars$carb)
c
barplot(table(mtcars$carb), col=1:
        main='no of cars of each carb',xlab='no of carbs', ylab='carbs type',horiz = T)
...
heatmap(data, scale="column", col = cm.colors(25))
heatmap(data, scale="column", col = terrain.colors(257))
