...
#----Read the dataset------
getwd()
#setwd("F:/rWork/rProjects/Analytics_Edge/Analytics_Edge_R")  //to set the location to file
Plan_Dataset <- read.csv("C:/Users/amit/Documents/R/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
sm2 <- read.csv("C:/Users/amit/Documents/R/InsurancePlanSubscriptions-2018.csv")
View(sm2)
